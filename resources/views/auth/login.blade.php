...
<div class="max-w-md mx-auto bg-white p-8 rounded-lg shadow mt-16">
    ...
    <p>
        Are you an Admin? 
        <a href="{{ route('admin.admins.create') }}" class="text-blue-600 hover:underline">Register as Admin</a>
    </p>
    <p>
        Are you a Therapist? 
        <a href="{{ route('admin.therapists.create') }}" class="text-blue-600 hover:underline">Register as Therapist</a>
    </p>
</div>
